...
import { GestionTypeForm } from "@/ui/components/forms/register/GestionType";
...
export const RegisterForm = ({ form }: Props) => {
  const { step, steps, currentStepIndex, back, next } = useMultiStepForm([
    <NameRegisterForm form={form} />,
    <ContactRegisterForm form={form} />,
    <PasswordRegisterForm form={form} />,
    <GestionTypeForm form={form} />,
  ]);
